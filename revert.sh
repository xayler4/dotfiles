...
declare -a DIR_NAMES=("nvim" "ranger" "alacritty" "polybar" "i3")
declare -a COMMANDS=("eval nvim --headless +PlugInstall +PlugClean! +qall!; cp -r ${CACHE}nvim/plugged/nvim-treesitter/parser/ ${TARGET}nvim/plugged/nvim-treesitter/" "" "alacritty" "chmod +x ${TARGET}polybar/launch.sh" "i3-msg restart")
